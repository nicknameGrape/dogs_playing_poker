		...
		"methods": {
			...
			"onMenu": function () {
				onload = function () {
					...
					fitText(context, "Do you have P.E.?", 0, 0, canvas.width, canvas.height / 3);
					var rows = 2
					for (var i=0; i<=deck.length; i++) {
						fitImage(context, game.images.stationery,
							i * subimageWidth,
							...
							(1 + Math.floor(i/(deck.length/rows)))*canvas.height*1/3,
				...
				game.images.stationery = loader.newImageAsset("subjects_strip.png", onload);
